...
$gamestorm_blog_date = get_theme_mod( 'gamestorm_blog_date', true );
$gamestorm_blog_comments = get_theme_mod( 'gamestorm_blog_comments', true );
$gamestorm_blog_author = get_theme_mod( 'gamestorm_blog_author', true );
$gamestorm_blog_cat = get_theme_mod( 'gamestorm_blog_cat', false );

?>


<div class="postbox__meta">
    <?php if ( !empty($gamestorm_blog_author) ): ?>
    ...
    <?php if ( !empty($gamestorm_blog_cat) ): ?>
