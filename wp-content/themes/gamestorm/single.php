...
<section class="tp-blog-area recently-completed blogs blog-section">
    <div class="container container-box  pt-120 pb-120">
        <div class="row">
									...
									<?php
			                            ...
			                            <div class="col-lg-6 col-md-6">
			                                <div class="theme-navigation b-next-post text-left mb-30">
			                                    <span><?php print esc_html__( 'Prev Post', 'gamestorm' );?></span>
								...
								<?php
		                            ...
		                            <div class="col-lg-6 col-md-6">
		                                <div class="theme-navigation b-next-post text-left text-md-right  mb-30">
		                                    <span><?php print esc_html__( 'Next Post', 'gamestorm' );?></span>
