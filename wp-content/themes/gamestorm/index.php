...
<section class="tp-blog-area pt-120 pb-120 recently-completed blogs blog-section">
					...
					<?php
						...
						<nav aria-label="Page navigation" class="d-flex mt-15">
		               		...
		               		<div class="basic-pagination mb-40 pagination justify-content-left">
			               		<?php gamestorm_pagination( '<i class="fal fa-arrow-left"></i>', '<i class="fal fa-arrow-right"></i>', '', ['class' => ''] );?>
			                </div>
							</nav>
						<?php
						else:
