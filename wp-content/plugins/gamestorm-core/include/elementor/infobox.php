 ...
 * @since 1.0.0
 */
class TP_Infobox extends Widget_Base
{
    ...
    protected function register_controls()
    {
       ...
       $this->add_control(
           ...
           [
               ...
               'selectors' => [
                   '{{WRAPPER}} .our-game-features.benefits .icon-box svg path' => 'fill: {{VALUE}}',
               ],
           ]
       );
       $this->add_control(
           ...
           [
               ...
               'type' => \Elementor\Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .our-game-features.benefits .icon-box' => 'background: {{VALUE}}',
               ],
           ]
       );
       ...
       $this->add_group_control(
           ...
           [
               ...
               'selector' => '{{WRAPPER}} .our-game-features .single-box h5',
       ...
       $this->add_control(
           ...
           [
               ...
               'type'      => Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .our-game-features .single-box h5' => 'color: {{VALUE}};',
               ],
           ]
       );
       $this->add_control(
           'process_style_title_cholor',
           [
       ...
       $this->add_control(
           ...
           [
               ...
               'type' => \Elementor\Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .our-game-features.benefits .single-box' => 'background: {{VALUE}}',
               ],
           ]
       );
       $this->add_control(
           ...
           [
               ...
               'type' => \Elementor\Controls_Manager::COLOR,
               'selectors' => [
                   '{{WRAPPER}} .box-style.box-second:hover:before' => 'background: {{VALUE}}',
               ],
           ]
       );
    ...
    protected function render()
    {
        ...
        <section class="our-game-features benefits pt-120 pb-120">
            <div class="container">
...
$widgets_manager->register(new TP_Infobox());
