...
class TP_Process extends Widget_Base
{
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'list_title' => esc_html__('Script Writing', 'gamestorm-core'),
                        'list_content' => esc_html__('We start by sketching the script using your instructions as a guide, and we then wait for your approval before moving.', 'gamestorm-core'),
                    ],
                    [
                        'list_title' => esc_html__('Story Board', 'gamestorm-core'),
                        'list_content' => esc_html__('We draw a representation of your work that shows the camera angles and the script.', 'gamestorm-core'),
                    ],
                    [
                        'list_title' => esc_html__('3D Modeling', 'gamestorm-core'),
                        'list_content' => esc_html__('We create the objects, people, settings, and other things that go into creating your video.', 'gamestorm-core'),
                    ],
                    [
                        'list_title' => esc_html__('Animation', 'gamestorm-core'),
                        'list_content' => esc_html__('After creating the animations and adding voiceovers and sound effects, we turn the project over.', 'gamestorm-core'),
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .icon-box.d-center.m-auto svg path' => 'fill: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .how-it-works .icon-box' => 'background: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .how-it-works .single-box:hover .icon-box' => 'background: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Typography', 'plugin-name'),
                'name'     => 'process_style_title_typ',
                'selector' => '{{WRAPPER}} h4.mt-6.mb-3',
        
            ]
        );
        
        $this->add_control(
            'process_style_title_color',
            [
                'label'     => esc_html__('Color', 'plugin-name'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} h4.mt-6.mb-3' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .how-it-works .abs-area i' => 'color: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .how-it-works .abs-area ' => 'background: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .how-it-works .single-box' => 'background: {{VALUE}}',
                ],
            ]
        );
        $this->add_control(
            'spinfdsfsdafner_color',
            [
                'label' => esc_html__( 'Hover Background Color', 'plugin-name' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render()
    {
        ...
        <section class="how-it-works pt-120 pb-120">
            <div class="container">
                ...
                <div class="row cus-mar">
                    <?php foreach ($settings['list_repeater'] as $item) : ?>
                        <div class="col-sm-6 col-xl-3 position-relative d-center">
                            <div class="abs-area d-center position-absolute">
                                <i class="material-symbols-outlined mat-icon"><?php echo esc_html('double_arrow') ?></i>
                            </div>
                            <div class="single-box box-style box-first d-grid align-items-center text-center p-5 px-xl-8 py-xl-10">
                                ...
                                <div class="title-area">
                                    <?php if (!empty($item['list_title'])) :   ?>
                                        <h4 class="mt-6 mb-3"><?php echo esc_html($item['list_title']) ?></h4>
                                    <?php endif ?>
