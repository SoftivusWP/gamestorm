...
class TP_IconBox extends Widget_Base {
	...
	public function get_title() {
		return __( 'Icon Box', 'gamestorm-core' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'tp_icon_type',
            [
                'label' => esc_html__('Select Icon Type', 'gamestorm-core'),
                'type' => \Elementor\Controls_Manager::SELECT,
                'default' => 'icon',
                'options' => [
                    'image' => esc_html__('Image', 'gamestorm-core'),
                    'icon' => esc_html__('Icon', 'gamestorm-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            'tp_icon_image',
            [
                'label' => esc_html__('Upload Image', 'gamestorm-core'),
       ...
       // tp_btn_button_group
        ...
        $this->add_control(
            'tp_btn_button_show',
            [
                'label' => esc_html__( 'Show Button', 'gamestorm-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('Button Text', 'gamestorm-core'),
                'title' => esc_html__('Enter button text', 'gamestorm-core'),
                'label_block' => true,
                'condition' => [
        ...
        $this->add_control(
            'tp_btn_link_type',
            [
                'label' => esc_html__('Button Link Type', 'gamestorm-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '1' => 'Custom Link',
                    '2' => 'Internal Page',
        ...
        $this->add_control(
            'tp_btn_page_link',
            [
                'label' => esc_html__('Select Button Page', 'gamestorm-core'),
