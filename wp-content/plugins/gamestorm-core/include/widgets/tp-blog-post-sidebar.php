<?php
	/**
	 * Gamestorm Sidebar Posts Image
	 *
	 *
	 * @author 		Gamestorm
	 * @category 	Widgets
	 * @package 	Gamestorm/Widgets
	 * @version 	1.0.0
	 * @extends 	WP_Widget
	*/
...
Class TP_Post_Sidebar_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('tp-latest-posts', 'Gamestorm Sidebar Posts Image', array(
			'description'	=> 'Latest Blog Post Widget by Gamestorm'
		));
	}
	...
	public function form($instance){
		...
		$count = ! empty( $instance['count'] ) ? $instance['count'] : esc_html__( '3', 'gamestorm-core' );
		$posts_order = ! empty( $instance['posts_order'] ) ? $instance['posts_order'] : esc_html__( 'DESC', 'gamestorm-core' );
		$choose_style = ! empty( $instance['choose_style'] ) ? $instance['choose_style'] : esc_html__( 'style_1', 'gamestorm-core' );
	?>
		<p>
