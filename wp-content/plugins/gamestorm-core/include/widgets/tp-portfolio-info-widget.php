<?php
	/**
	 * Gamestorm Portfolio Info Widget
	 *
	 *
	 * @author 		Gamestorm
	 * @category 	Widgets
	...
	class tp_portfolio_info_widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('tp_portfolio_info_widget',esc_html__('TP Portfolio Info','gamestorm-core'),array(
				'description' => esc_html__('TP Portfolio Info Widget by Theme_Pure','gamestorm-core'),
			));
		}
