<?php
	...
	class tp_sidebar_form_widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('tp_sidebar_form_widget',esc_html__('Gamestorm Sidebar Form','gamestorm-core'),array(
				'description' => esc_html__('TP Sidebar Form Widget by Theme_Pure','gamestorm-core'),
			));
		}
		...
		public function form($instance){
			...
			?>
			<p>
				<label for="title"><?php esc_html_e('Title:','gamestorm-core'); ?></label>
			</p>
			...
			<p>
				<label for="title"><?php esc_html_e('Form Shortcode:','gamestorm-core'); ?></label>
			</p>
