<?php
/**
	* Plugin Name: Gamestorm Core
	* Description: Gamestorm core plugin.
	* Plugin URI:  https://themeforest.net/user/uiaxis
	* Version:     1.0.0
	* Author:      Softivus
	* Author URI:  https://themeforest.net/user/uiaxis/
	* Text Domain: gamestorm-core
*/
 ...
 * Include all files
*/
include_once(TPCORE_ADDONS_DIR . '/include/custom-post-game.php');
...
include_once(TPCORE_WIDGET_PATH . '/tp-social.php');
include_once(TPCORE_WIDGET_PATH . '/tp-info.php');
include_once(TPCORE_WIDGET_PATH . '/tp-ins.php');
